...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	|	ЕСТЬNULL(ВКМ_УсловияОплатыСотрудниковСрезПоследних.ПроцентЗаВыполненныеРаботы, 0) КАК ПроцентЗаВыполненныеРаботы,
	|	ЕСТЬNULL(ВКМ_УсловияОплатыСотрудниковСрезПоследних.НулевойПроцент, 0) КАК НулевойПроцент
	|ИЗ
...
Процедура ПроверкаЗаполнения(Отказ)
	...
	Если РеквизитыДоговора.ВидДоговора <> Перечисления.ВидыДоговоровКонтрагентов.ВКМ_АбоненскоеОбслуживание Тогда
		ТекстСообщения = "Тип договора не подходит для обслуживания";
