...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// ++ 2026.03 Ливенцев правки
	
	//Бухгалтер
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Бухгалтер";
	ОписаниеПрофиля.Идентификатор = "338512c7-10e1-11f1-add8-4c82a9bc621e";
	...
	ОписаниеПрофиля.Идентификатор = "338512c8-10e1-11f1-add8-4c82a9bc621e";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеСправочникаСпециалисты");
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДоступКОтчетуРасчетССотрудниками");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	//Менеджер
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "338512c6-10e1-11f1-add8-4c82a9bc621e";
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДополнительныхОтчетовИОбработок");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументаОбслуживанияКлиентов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеВзаиморасчетовСПоставщиками");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	...
	ОписаниеПрофиля.Идентификатор = "338512c5-10e1-11f1-add8-4c82a9bc621e";
